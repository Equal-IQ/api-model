...
export type ContractSummary = ExtractSchema<'ContractSummary'>
...
export type EQResult = ExtractSchema<'EQResult'>
...
export type IQAnswersMarkupResult = ExtractSchema<'IQAnswersMarkupResult'>
...
export type IQResult = ExtractSchema<'IQResult'>
...
export type PerspectiveQASet = ExtractSchema<'PerspectiveQASet'>
...
export type SummaryResult = ExtractSchema<'SummaryResult'>
...
export type VariableExtractionResult = ExtractSchema<'VariableExtractionResult'>
