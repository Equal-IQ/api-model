...
export type GetComposerContractContentResponseContent = ExtractSchema<'GetComposerContractContentResponseContent'>
export type GetComposerContractMetaRequestContent = ExtractSchema<'GetComposerContractMetaRequestContent'>
export type GetComposerContractMetaResponseContent = ExtractSchema<'GetComposerContractMetaResponseContent'>
...
export type TermSection = ExtractSchema<'TermSection'>
export type UpdateComposerContractContentRequestContent = ExtractSchema<'UpdateComposerContractContentRequestContent'>
export type UpdateComposerContractContentResponseContent = ExtractSchema<'UpdateComposerContractContentResponseContent'>
export type UpdateComposerContractMetaRequestContent = ExtractSchema<'UpdateComposerContractMetaRequestContent'>
export type UpdateComposerContractMetaResponseContent = ExtractSchema<'UpdateComposerContractMetaResponseContent'>
