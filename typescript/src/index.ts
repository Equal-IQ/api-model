...
export type ComposerContract = ExtractSchema<'ComposerContract'>
export type ComposerContractResult = ExtractSchema<'ComposerContractResult'>
...
export type DeleteComposerContractRequestContent = ExtractSchema<'DeleteComposerContractRequestContent'>
export type DeleteComposerContractResponseContent = ExtractSchema<'DeleteComposerContractResponseContent'>
...
export type GetComposerContractRequestContent = ExtractSchema<'GetComposerContractRequestContent'>
export type GetComposerContractResponseContent = ExtractSchema<'GetComposerContractResponseContent'>
...
export type SubmitComposerContractForAnalysisRequestContent = ExtractSchema<'SubmitComposerContractForAnalysisRequestContent'>
export type SubmitComposerContractForAnalysisResponseContent = ExtractSchema<'SubmitComposerContractForAnalysisResponseContent'>
export type Term = ExtractSchema<'Term'>
export type UpdateComposerContractRequestContent = ExtractSchema<'UpdateComposerContractRequestContent'>
export type UpdateComposerContractResponseContent = ExtractSchema<'UpdateComposerContractResponseContent'>
