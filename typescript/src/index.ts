...
export type GetContractAnalysisRequestContent = ExtractSchema<'GetContractAnalysisRequestContent'>
export type GetContractAnalysisResponseContent = ExtractSchema<'GetContractAnalysisResponseContent'>
export type GetContractMetadataRequestContent = ExtractSchema<'GetContractMetadataRequestContent'>
export type GetContractMetadataResponseContent = ExtractSchema<'GetContractMetadataResponseContent'>
...
export type ListContractMetadataResponseContent = ExtractSchema<'ListContractMetadataResponseContent'>
